...
main(int argc, char *argv[])
{
  ...
  21:	7e 2b                	jle    4e <main+0x4e>
  23:	c7 44 24 0c 2d 07 00 	movl   $0x72d,0xc(%esp)
  2a:	00 
  2b:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2f:	83 c3 01             	add    $0x1,%ebx
  32:	c7 44 24 04 2f 07 00 	movl   $0x72f,0x4(%esp)
  39:	00 
  3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  41:	89 44 24 08          	mov    %eax,0x8(%esp)
  45:	e8 c6 03 00 00       	call   410 <printf>
  4a:	39 de                	cmp    %ebx,%esi
  4c:	7f d5                	jg     23 <main+0x23>
  4e:	c7 44 24 0c 34 07 00 	movl   $0x734,0xc(%esp)
  55:	00 
  56:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  5a:	c7 44 24 04 2f 07 00 	movl   $0x72f,0x4(%esp)
  61:	00 
  62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  69:	89 44 24 08          	mov    %eax,0x8(%esp)
  6d:	e8 9e 03 00 00       	call   410 <printf>
  exit();
  72:	e8 4d 02 00 00       	call   2c4 <exit>
  77:	90                   	nop
  78:	90                   	nop
  79:	90                   	nop
  7a:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	f7 f6                	div    %esi
 3c4:	0f b6 92 3d 07 00 00 	movzbl 0x73d(%edx),%edx
 ...
 427:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 508:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 36 07 00 00       	mov    $0x736,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 50 07 00 00       	mov    0x750,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ef:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f1:	a3 50 07 00 00       	mov    %eax,0x750
}
 5f6:	5b                   	pop    %ebx
 5f7:	5e                   	pop    %esi
 5f8:	5f                   	pop    %edi
 ...
 610:	03 51 04             	add    0x4(%ecx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 613:	a3 50 07 00 00       	mov    %eax,0x750
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 63c:	8b 35 50 07 00 00    	mov    0x750,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 678:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67a:	3b 15 50 07 00 00    	cmp    0x750,%edx
 ...
 699:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 69c:	89 35 50 07 00 00    	mov    %esi,0x750
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 6da:	e8 c1 fe ff ff       	call   5a0 <free>
  return freep;
 6df:	8b 15 50 07 00 00    	mov    0x750,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 6fc:	eb 9e                	jmp    69c <malloc+0x6c>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 50 07 00 00 54 	movl   $0x754,0x750
 705:	07 00 00 
    base.s.size = 0;
 708:	ba 54 07 00 00       	mov    $0x754,%edx
  Header *p, *prevp;
  uint nunits;
