...
main(int argc, char *argv[])
  ...
  25:	e8 ea 02 00 00       	call   314 <unlink>
  ...
  exit();
  38:	e8 87 02 00 00       	call   2c4 <exit>
  ...
  42:	c7 44 24 04 41 07 00 	movl   $0x741,0x4(%esp)
  49:	00 
  ...
  exit();
  5a:	e8 65 02 00 00       	call   2c4 <exit>
  5f:	90                   	nop
main(int argc, char *argv[])
{
  int i;
  ...
  if(argc < 2){
    printf(2, "Usage: rm files...\n");
  60:	c7 44 24 04 2d 07 00 	movl   $0x72d,0x4(%esp)
  67:	00 
  68:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6f:	e8 9c 03 00 00       	call   410 <printf>
    exit();
  74:	e8 4b 02 00 00       	call   2c4 <exit>
  79:	90                   	nop
  7a:	90                   	nop
  7b:	90                   	nop
  7c:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	f7 f6                	div    %esi
 3c4:	0f b6 92 61 07 00 00 	movzbl 0x761(%edx),%edx
 ...
 427:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 508:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 5a 07 00 00       	mov    $0x75a,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 74 07 00 00       	mov    0x774,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5ef:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f1:	a3 74 07 00 00       	mov    %eax,0x774
}
 5f6:	5b                   	pop    %ebx
 5f7:	5e                   	pop    %esi
 5f8:	5f                   	pop    %edi
 ...
 610:	03 51 04             	add    0x4(%ecx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 613:	a3 74 07 00 00       	mov    %eax,0x774
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 63c:	8b 35 74 07 00 00    	mov    0x774,%esi
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 678:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67a:	3b 15 74 07 00 00    	cmp    0x774,%edx
 ...
 699:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 69c:	89 35 74 07 00 00    	mov    %esi,0x774
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 6da:	e8 c1 fe ff ff       	call   5a0 <free>
  return freep;
 6df:	8b 15 74 07 00 00    	mov    0x774,%edx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 6fc:	eb 9e                	jmp    69c <malloc+0x6c>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 74 07 00 00 78 	movl   $0x778,0x774
 705:	07 00 00 
    base.s.size = 0;
 708:	ba 78 07 00 00       	mov    $0x778,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70d:	c7 05 78 07 00 00 78 	movl   $0x778,0x778
 714:	07 00 00 
    base.s.size = 0;
 717:	c7 05 7c 07 00 00 00 	movl   $0x0,0x77c
 71e:	00 00 00 
